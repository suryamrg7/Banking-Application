			...
			try {
				...
				if (rs.next()) {
					...
					pw.print("<table align = 'center'>" + "<tr> " + "<td> <label> Account Number = </label> </td>"
							...
							+ "</tr>" + "<tr> " + "<td> <label> Account Name = </label> </td>"
							+ "<td> <input type='text' name = 'aname' value='" + rs.getString("aname") + "'" + "</tr>"
							+ "<tr> " + "<td> <label> Balance = </label> </td>"
							+ "<td> <input type='text' name='abal' readonly value='" + rs.getInt("abal") + "'" + "</tr>"
							+ "<tr>" + "<td colspan='2'><input type='submit' value='Update'/>" + "</tr>" + "</table");
					pw.print("<form>");
				} else {
